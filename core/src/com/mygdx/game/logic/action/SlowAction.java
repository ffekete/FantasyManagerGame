...
public class SlowAction implements Action {
    ...
    @Override
    public void update() {
        SpriteBatchRegistry.INSTANCE.getSpriteBatch().draw(texture, coordinates.getX(), coordinates.getY(), 0.0f, 0.0f, 1, 1, 1, 1, 0.0f, (int)phase * 32 ,0, (int)phase * 32 + 32, texture.getHeight(), false, false);
