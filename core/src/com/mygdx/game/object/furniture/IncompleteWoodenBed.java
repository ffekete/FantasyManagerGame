...
public class IncompleteWoodenBed implements WorldObject, Obstacle, Bed, Furniture, BuildingBlock {

    private Point coordinates;
    private float progress = 0.0f;

    public IncompleteWoodenBed(Point coordinates) {
