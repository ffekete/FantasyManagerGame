...
public class IncompletePracticeFigure implements WorldObject, Obstacle, Furniture, BuildingBlock {

    private Point coordinates;
    private float progress = 0.0f;

    public IncompletePracticeFigure(Point coordinates) {
